  ...
  const styles = {
   ...
   const ItemSelectFields = (props) => {
    ...
    const [ inputFields1, setInputFields1 ] = useState([
        { id: uuidv4(),added_by:"",type_code:"",item_name :"", item_qty: "", item_description:"" },
    ]);
    ...
    const handleAddFields = () => {
        setInputFields1([...inputFields1, { id: uuidv4(),added_by:"",type_code:"",item_name :"",  item_qty: "", item_description:"" }])
      }
...
if(inputFields1 != ""){
  ...
  console.log("kkkkkkk",inputFields1);
}
else{ 
  alert("fields");
}
              ...
              size = "small"
                ...
                <MenuItem defaultValue = "">None</MenuItem>
                {
                  record.map((item, index) => (
                   <MenuItem key = {index}   value={item.code} >{item.itemname}</MenuItem>))
