...
<Box className={classes.wrapper}>
    ...
    {/* <Route exact path='/' component={(props)=> <Protected Cmp = {Dashboard} {...props}/>} /> */}
            ...
            <Route exact path='/bookings/mainpage' component={(props)=><Protected2 Cmp ={MainPage}{...props}/>} />
            <Route exact path='/bookings/mainpage/mybookings' component={(props)=> <Protected2 Cmp ={BookingTable}{...props}/>} />
            <Route exact path='/bookings/mainpage/mydonations' component={(props)=><Protected2 Cmp ={AddBookings}{...props}/>} />
