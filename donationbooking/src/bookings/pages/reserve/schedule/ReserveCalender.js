...
{
  if(mark.find(x=>x===moment(date).format("YYYY-MM-DD"))){
    return  view === 'month' && <Link to="/bookings/mainpage/mybookings"><BsFillHeartFill data-toggle="tooltip" data-placement="bottom" title="Already reserved for a donation"/> </Link> ;
   }
}}
